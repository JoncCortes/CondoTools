...
from apps.rbac.views import MyPermissionsView, PermissionRegistryView, RolePermissionSetViewSet
...
router.register("role-permissions", RolePermissionSetViewSet, basename="role-permissions")
...
urlpatterns = [
    ...
    path("api/permissions/registry/", PermissionRegistryView.as_view(), name="permissions-registry"),
    path("api/permissions/me/", MyPermissionsView.as_view(), name="permissions-me"),
