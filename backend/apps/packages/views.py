...
class PackageViewSet(BaseCondoViewSet):
    ...
    permission_map = {
        "list": "packages.view",
        "retrieve": "packages.view",
        "create": "packages.create",
        "update": "packages.update",
        "partial_update": "packages.update",
        "destroy": "packages.delete",
        "mark_picked_up": "packages.mark_delivered",
    }
...
class PackageAuditLogViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    permission_classes = [permissions.IsAuthenticated, HasRBACPermission]
    permission_map = {"list": "packages.audit_log.view", "retrieve": "packages.audit_log.view", "export_csv": "packages.audit_log.view"}
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
